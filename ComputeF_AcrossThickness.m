function F = ComputeF_AcrossThickness(mAnalysis,nAnalysis,p,q,UAnalysis,VAnalysis,UEle,VEle,Ctrlpts,ploadsMat,loadType, ne_u, ne_v)

%%%%%% Compute the force vector in correlance to control points, the force is applied accross thickness direction %%%%%%
% input:
            ...
            for i1 = 1:numel(uu)
                ...
                for j1 = 1:numel(vv)
                    ...
                    for a = 1:numel(w3_vec)
                        ...
                        F(dispIdxIJ) = F(dispIdxIJ) + M'* pload' * w3_vec(a) * dl_dzeta;
                    end
            ...
            for j = 1:ne_v
                ...
                for k = 1:ng_v
                    ...
                    for a = 1:numel(w3_vec)
                        ...
                        dA = norm(cross(JS(2,:), JS(3,:)));  % A: the section s = s0
                        Fe = Fe + M'* pload' * dA * w_vec(k) * w3_vec(a);
                    end
                end
            ...
            for i = 1:ne_u
                ...
                for k = 1:ng_u
                    ...
                    for a = 1:numel(w3_vec)
                        ...
                        dA = norm(cross(JS(1,:), JS(3,:)));  % A: the section t = t0
                        Fe = Fe + M'* pload' * dA * w_vec(k) * w3_vec(a);
                    end
                end
