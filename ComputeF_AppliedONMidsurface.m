function F = ComputeF_AppliedONMidsurface(mAnalysis,nAnalysis,p,q,UAnalysis,VAnalysis,UEle,VEle,Ctrlpts,ploadsMat,loadType, ne_u, ne_v)

%%%%%% Compute the force vector in correlance to control points, the force is applied on mid-surface %%%%%%
% input:
        ...
        for kk = 1:size(ploadsMat,1)
            ...
            for i1 = 1:numel(uu)
                ...
                for j1 = 1:numel(vv)
                    ...
                    F(dispIdxIJ) = F(dispIdxIJ) + M'* pload';
